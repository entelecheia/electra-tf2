...
WORKING_DIR="/workspace/data/tbts/pathML/data"
...
DATASET_P1="tfrecord_lower_case_1_seq_len_128_random_seed_12345/pathobook_pubmed_ds/train/pretrain_data*" # change this for other datasets
DATA_DIR_P1=${21:-"$WORKING_DIR/$DATASET_P1"}
DATASET_P2="tfrecord_lower_case_1_seq_len_512_random_seed_12345/pathobook_pubmed_ds/train/pretrain_data*" # change this for other datasets
DATA_DIR_P2=${22:-"$WORKING_DIR/$DATASET_P2"}
CODEDIR=${23:-"/workspace/electra"}
init_checkpoint=${24:-"None"}
restore_checkpoint=${restore_checkpoint:-"true"}
RESULTS_DIR="/workspace/data/tbts/pathML/results/electra"
WANDB_PROJECT="electra_pathmed"
WANDB_GROUP="electra_pathmed"
...
CMD+=" --wandb_group ${WANDB_GROUP}_p1 "
...
CMD+=" --log_dir ${RESULTS_DIR} "
CMD+=" --wandb_project ${WANDB_PROJECT} "
CMD+=" --wandb_group ${WANDB_GROUP}_p2 "
